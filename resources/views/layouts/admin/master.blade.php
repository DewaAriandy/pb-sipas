...
<html lang="en">
  <head>
    ...
    <title>RSIA Puri Bunda || @yield('subtitle')</title>
    <!-- plugins:css -->
  ...
  <body>
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
          <a class="navbar-brand brand-logo" href="index.html"> <h3 class="text-white" style="margin-top:10px;">SIPAS</h3>
          <a class="navbar-brand brand-logo-mini" href="index.html">SIPAS</a>
        </div>
        <div class="navbar-menu-wrapper d-flex align-items-center">
          <ul class="navbar-nav">
            <li class="nav-item font-weight-semibold d-none d-lg-block">RSIA. PURI BUNDA |</li>
            <li class="nav-item d-none d-lg-block"> Sistem Informasi Pengelolaan Arsip Surat </li>            
          </ul>
        ...
        <div class="main-panel">
          ...
          <footer class="footer">
            <div class="container-fluid clearfix">
              ...
              <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Develop & made with <i class="mdi mdi-heart text-danger"></i> By IT Team
              </span>
            </div>
          </footer>
          <!-- partial -->
    ...
    <script src="{{asset('assets/assets/js/demo_1/dashboard.js')}}"></script>
